...
units='m/s'
model=str('eraint')
fileName ='u850_mon_eraint_1979-2015.nc'
ds = xr.open_dataset(sourceData+model+'/'+fileName)['u']
...
axs.add_geometries([geom], facecolor='None',edgecolor='green',crs=ccrs.PlateCarree(), alpha=0.3)
